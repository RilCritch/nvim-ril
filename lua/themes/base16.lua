...
themes["yoru"] = { -- my custom theme
	base00 = "0c0e0f"; -- default background
	base01 = "0c0e0f"; -- Lighter Background (Used for status bars, line number and folding marks)
	base02 = "343637"; -- Selection Background
	base03 = "505253"; -- Comments, Invisibles, Line Highlighting
	base04 = "27292a"; -- Dark Foreground (Used for status bars)
	base05 = "acb5b9"; -- Default Foreground, Caret, Delimiters, Operators
	base06 = "e4e6e7"; -- Light Foreground (Not often used)
	base07 = "f2f4f5"; -- Light Background (Not often used)
	base08 = "6791c9"; -- Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted
	base09 = "ecd28b"; -- Integers, Boolean, Constants, XML Attributes, Markup Link Url
	base0A = "e89982"; -- Classes, Markup Bold, Search Text Background
	base0B = "78b892"; -- Strings, Inherited Class, Markup Code, Diff Inserted
	base0C = "acb5b9"; -- Support, Regular Expressions, Escape Characters, Markup Quotes
	base0D = "ecd28b"; -- Functions, Methods, Attribute IDs, Headings
	base0E = "e89982"; -- Keywords, Storage, Selector, Markup Italic, Diff Changed
	base0F = "acb5b9"; -- Deprecated, Opening/Closing Embedded Language Tags, e.g. <?php ?>
}
